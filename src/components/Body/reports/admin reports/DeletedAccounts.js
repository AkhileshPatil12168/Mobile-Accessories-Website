          ...
          <table className="min-w-full bg-white border border-gray-300">
            <thead className="bg-indigo-500 text-white">
              <tr>
                ...
                <th className="py-2 px-4 border-b border-r text-center">Account Deleted At</th>
              </tr>
            </thead>
            <tbody>
...
const DeletedAccounts = () => {
  ...
  const getLoginLogoutSessions = async () => {
    try {
      const responce = await axios.get(process.env.backendapi + "/report/admin/accounts/deleted", {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-4 text-center">Deleted Accounts</h1>
